...
REM
REM Generated by Vivado on Fri Apr 10 12:40:20 +0800 2026
...
echo "xvlog --incr --relax -prj seg8_tb_vlog.prj"
call xvlog  --incr --relax -prj seg8_tb_vlog.prj -log xvlog.log
