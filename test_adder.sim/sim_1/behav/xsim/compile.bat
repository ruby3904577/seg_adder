...
REM
REM Generated by Vivado on Thu Apr 09 15:23:12 +0800 2026
...
echo "xvlog --incr --relax -prj bin2bcd_tb_vlog.prj"
call xvlog  --incr --relax -prj bin2bcd_tb_vlog.prj -log xvlog.log
